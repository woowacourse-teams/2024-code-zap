...
public interface SpringDocsLikesController {
    ...
    @ApiErrorResponse(status = HttpStatus.NOT_FOUND, instance = "/like/1", errorCases = {
            @ErrorCase(description = "템플릿 Id 에 해당하는 템플릿이 존재하지 않는 경우", errorCode = ErrorCode.RESOURCE_NOT_FOUND,
