    ...
    <S.TemplateCardContainer data-testid='template-card'>
        ...
        <Link to={END_POINTS.template(template.id)}>
          <Flex direction='column' gap='0.5rem'>
            <S.EllipsisTextWrapper>
              <Text.XLarge
                color={theme.color.light.secondary_900}
                weight='bold'
              >
                {title}
              </Text.XLarge>
      ...
      <Flex justify='space-between' onClick={blockMovingToDetailPage}>
        ...
        <Button
          ...
          onMouseEnter={handleAllTagList}
        >
          <Text.XSmall
            color={
              tags.length !== 0
                ? theme.color.light.secondary_500
                : 'transparent'
            }
          >
            모든 태그
      ...
      <S.AllTagListModal
        onClick={blockMovingToDetailPage}
        onMouseLeave={handleAllTagList}
      >
